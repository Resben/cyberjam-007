...
namespace R3DWorks{
    ...
    public sealed class R3DWorksURPDitheringRendererFeature : ScriptableRendererFeature
    {
    ...
    #if UNITY_EDITOR
            if (m_Shader == null)
                m_Shader = Shader.Find("Hidden/R3DWorks/URPDithering");
    #endif
            if(!m_Material){
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            R3DWorksURPDitheringVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<R3DWorksURPDitheringVolumeComponent>();
        ...
        private class CustomPostRenderPass : ScriptableRenderPass
        {
            ...
            private static void ExecuteMainPass(RasterCommandBuffer cmd, RTHandle sourceTexture, Material material)
            {
                ...
                if (myVolume != null)
                    ...
                    s_SharedPropertyBlock.SetInt("_PixelSize",myVolume.pixelSize.value);
                    s_SharedPropertyBlock.SetInt("_ColorRange", myVolume.colorRange.value);
