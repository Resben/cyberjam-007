...
namespace R3DWorks{
    ...
    [VolumeComponentMenu("Post-processing R3D Works/URP Dithering")]
    [VolumeRequiresRendererFeatures(typeof(R3DWorksURPDitheringRendererFeature))]
    [SupportedOnRenderPipeline(typeof(UniversalRenderPipelineAsset))]
    public sealed class R3DWorksURPDitheringVolumeComponent : VolumeComponent, IPostProcessComponent
    {
        public R3DWorksURPDitheringVolumeComponent()
        {
            displayName = "R3DWorksURPDithering";
        }

        [Tooltip("Controls the blending intensity of the effect")]
        public ClampedFloatParameter intensity = new ClampedFloatParameter(1f, 0f, 1f);
        [Tooltip("Scales the pixel size of the image")]
        public ClampedIntParameter pixelSize = new ClampedIntParameter(1,1,16);
        [Tooltip("Multiplies the range of colors. Higher value means more color values")]
        public ClampedIntParameter colorRange = new ClampedIntParameter(1,1,256);
